...
#if !UNITY_5_0 && !UNITY_2017_2_OR_NEWER
        ...
        void LateUpdate()
        {
            ...
            else
            {
                ...
                if (step == 3)
                {
                    ...
                    //string ffmpegPath = Application.dataPath + "\\VRPanorama\\StreamingAssets\\";  ---插件自带的
                    string ffmpegPath = Application.dataPath + "\\ThirdPartys\\VRPanorama\\StreamingAssets\\";
